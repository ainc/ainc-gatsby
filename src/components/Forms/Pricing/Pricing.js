...
const Pricing = ({ lgShow, hide }) => {
  ...
  return (
    <ModalCustom
      lgShow={formSubmitted ? false : lgShow}
      hide={hide}
      backdrop="static"
    >
      <Form onSubmit={(e) => handleSubmit(e)}>
        ...
        <Form.Group className={styles.formGroup} controlId="FormLastName">
          <Form.Label className={styles.center}>Last Name</Form.Label>
          <Form.Control
            type="text"
        ...
        <Form.Group className={styles.formGroup} controlId="FormEmail">
          <Form.Label className={styles.center}>Email Address</Form.Label>
          <Form.Control
            type="email"
        ...
        <Form.Group className={styles.formGroup} controlId="FormPhone">
          <Form.Label className={styles.center}>Phone</Form.Label>
          <Form.Control
            type="phone"
        ...
        <Form.Group
          className={`mt-4 ${styles.formGroup}`}
        ...
        <Form.Group
          className={`mt-4 ${styles.formGroup}`}
          controlId="FormOccupy"
        >
          <Form.Label className={styles.center}>
            How long do you plan on occupying space at Awesome Inc (There is no
        ...
        >
          <Form.Label className={styles.center}>
            Please provide a brief bio of yourself and your business
            goals/objectives
          </Form.Label>
          <Form.Control
            as="textarea"
