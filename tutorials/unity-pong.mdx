...
![Classic Pong screenshot](../src/images/tutorials/unity-pong/classic_pong_screenshot.png)

By Will Oldham. Updates by <a href="https://github.com/nicksuch/" target="_blank">Nick Such</a> and <a href="https://github.com/TheSpydog/" target="_blank">Caleb Cornett</a>
...
First, download this <a href="/includes/unity-pong-assets.zip" target="_blank">**Unity Pong assets file**</a>. It contains images and other assets that we'll be using in this tutorial.
...
![Unity's New Project window](../src/images/tutorials/unity-pong/unity-new-project.png)
...
Remember that <a href="/includes/unity-pong-assets.zip" target="_blank">Unity Pong assets file</a> that we downloaded? Now's a great time to unzip that file. Once you do, you'll see a folder called `unitypong-assets`, which will contain a set of images, fonts, and other assets that we'll be using today. Select all of these files, then <kbd>click + drag</kbd> them into the Project pane at the bottom of your Unity window. It should now look something like this:

![Background image selected in Project pane](../src/images/tutorials/unity-pong/background_project_pane.png)
...
![Background image in hierarchy](../src/images/tutorials/unity-pong/background_hierarchy_pane.png)
...
![Sorting Layers](../src/images/tutorials/unity-pong/sorting_layer.png)
...
![Background image in Background Sorting layer](../src/images/tutorials/unity-pong/background_sorting_layer.png)
...
![MainCamera properties](../src/images/tutorials/unity-pong/main_camera_inspector.png)
...
![Paddle setup](../src/images/tutorials/unity-pong/paddle-setup.png)
...
![Physics - Box Collider 2D and Rigidbody 2D](../src/images/tutorials/unity-pong/player01_physics.png)
...
![Create New Script](../src/images/tutorials/unity-pong/image_6.png)
...
![Play mode symbol](../src/images/tutorials/unity-pong/playmode.png)
...
![image alt text](../src/images/tutorials/unity-pong/image_12.png)
...
![Tagging the Ball](../src/images/tutorials/unity-pong/assign_ball_tag.png)
...
![Physics settings for Ball](../src/images/tutorials/unity-pong/ball_inspector_physics.png)
...
![Right wall](../src/images/tutorials/unity-pong/rightwall.png)
...
![Walls in the scene view](../src/images/tutorials/unity-pong/walls_sceneview.png)
...
![Score Skin with font applied](../src/images/tutorials/unity-pong/score_skin.png)
...
![Game Manager with skin applied to layout](../src/images/tutorials/unity-pong/game_manager_layout.png)

Awesome! Now you should, when you play, see something like this:

![GUI font and sizes enabled](../src/images/tutorials/unity-pong/gui_font_enabled.png)
...
![Is Trigger checkbox](../src/images/tutorials/unity-pong/istrigger.png)
...
![Build Settings](../src/images/tutorials/unity-pong/build_settings.png)
...
![Player Settings](../src/images/tutorials/unity-pong/player_settings.png)
...
## THANKS, AND GAME ON
 ...
 ![Finished Unity Pong game](../src/images/tutorials/unity-pong/finished_pong_game.png)
