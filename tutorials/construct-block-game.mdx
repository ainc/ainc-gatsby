...
![Block-Stacking Game made with Construct 3](../src/images/tutorials/construct-block-game/finishedproduct.png){:width="400"}
...
![Blocks](../src/images/tutorials/construct-block-game/blocks.jpg){:width="300"} 
...
![Finished Product](../src/images/tutorials/construct-block-game/finishedproduct.png){:width="400"}
...
![Welcome](../src/images/tutorials/construct-block-game/cewelcome.png){:width="640"}
...
![Annotated menu](../src/images/tutorials/construct-block-game/cemainmenu_annotated.png){:width="640"}
...
![New Project](../src/images/tutorials/construct-block-game/newproj.png)
...
![Layout Editor](../src/images/tutorials/construct-block-game/layouteditor.png){:width="640"}
...
![Layout Props](../src/images/tutorials/construct-block-game/layoutprops.png)
...
![Resized Layout](../src/images/tutorials/construct-block-game/resizedlayout.png){:width="640"}
...
![Choose Sprite](../src/images/tutorials/construct-block-game/choosesprite.png){:width="400"}
...
![Image Editor](../src/images/tutorials/construct-block-game/imageeditor.png){:width="640"}
...
![Solid Black](../src/images/tutorials/construct-block-game/solidblack.png){:width="640"}
...
![](../src/images/tutorials/construct-block-game/scaledpositionedground.png){:width="640"}
...
![](../src/images/tutorials/construct-block-game/layoutwithblock.png){:width="640"}
...
![](../src/images/tutorials/construct-block-game/playbutton.png)

Click the button, then navigate to `Project > Save As > Save to Local Browser`.

![](../src/images/tutorials/construct-block-game/savetolocalbrowser.png)
...
![](../src/images/tutorials/construct-block-game/behaviors.png)
...
![](../src/images/tutorials/construct-block-game/addnewbehavior.png)
...
![](../src/images/tutorials/construct-block-game/physicsbehavior.png)
...
![](../src/images/tutorials/construct-block-game/physicsbehaviorproperties.png)
...
![](../src/images/tutorials/construct-block-game/elasticity.png)
...
![](../src/images/tutorials/construct-block-game/tabs.png)

Click that tab, and you'll be taken to the Event Sheet editor:

![](../src/images/tutorials/construct-block-game/eventsheet.png)
...
![](../src/images/tutorials/construct-block-game/addcondition.png)
...
![](../src/images/tutorials/construct-block-game/onclick.png)
...
![](../src/images/tutorials/construct-block-game/addaction.png)
...
![](../src/images/tutorials/construct-block-game/addcreateobject.png)
...
![](../src/images/tutorials/construct-block-game/createobject.png)
...
![](../src/images/tutorials/construct-block-game/addevent2.png)

Again, click the `Mouse` object and click `Next`. Now select the `Mouse button is down` Condition.

![](../src/images/tutorials/construct-block-game/mousebuttonisdown.png)
...
![](../src/images/tutorials/construct-block-game/event2.png)
...
![](../src/images/tutorials/construct-block-game/destroy.png)
...
![](../src/images/tutorials/construct-block-game/white.png)
...
![](../src/images/tutorials/construct-block-game/oncreated.png)
...
![](../src/images/tutorials/construct-block-game/setcolor.png)
